...
public class MyServiceImplServiceLocator extends org.apache.axis.client.Service implements com.ak.example.MyServiceImplService {
    ...
    private java.lang.String MyServiceImplPort_address = "http://localhost:8081/cxf";
    ...
    public com.ak.example.MyServiceImpl getMyServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ak.example.MyServiceImpl getMyServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ak.example.MyServiceImplServiceSoapBindingStub _stub = new com.ak.example.MyServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ak.example.MyServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ak.example.MyServiceImplServiceSoapBindingStub _stub = new com.ak.example.MyServiceImplServiceSoapBindingStub(new java.net.URL(MyServiceImplPort_address), this);
                _stub.setPortName(getMyServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.example/", "MyServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.example/", "MyServiceImplPort"));
        }
