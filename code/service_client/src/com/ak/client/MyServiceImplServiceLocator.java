...
public class MyServiceImplServiceLocator extends org.apache.axis.client.Service implements com.ak.client.MyServiceImplService {
    ...
    private java.lang.String MyServiceImplPort_address = "http://localhost:9000/HelloWorld";
    ...
    public com.ak.client.MyServiceImpl getMyServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ak.client.MyServiceImpl getMyServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ak.client.MyServiceImplPortBindingStub _stub = new com.ak.client.MyServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ak.client.MyServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ak.client.MyServiceImplPortBindingStub _stub = new com.ak.client.MyServiceImplPortBindingStub(new java.net.URL(MyServiceImplPort_address), this);
                _stub.setPortName(getMyServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
